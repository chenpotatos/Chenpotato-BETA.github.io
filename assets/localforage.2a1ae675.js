...
*/
const r = t.exports = function e(t, r, o) {
    function i(u, c) {
        if (!r[u]) {
            if (!t[u]) {
    ...
    3: [function(n, t, r) {
        (function(e) {
            "function" != typeof e.Promise && (e.Promise = n(2))
        }).call(this, void 0 !== e ? e : "undefined" != typeof self ? self : "undefined" != typeof window ? window : {})
    }, {
        2: 2
    }],
    4: [function(e, n, t) {
        ...
        function w(e) {
            return "boolean" == typeof y ? f.resolve(y) : I(e).then((function(e) {
                return y = e
            }))
        }
        ...
        function L(e) {
            ...
            var o = p[t.name];
            o || (o = F(), p[t.name] = o), o.forages.push(n), n._initReady || (n._initReady = n.ready, n.ready = k);
            var i = [];
        ...
        function P(e, n, t) {
            ...
            var o = new f((function(t, o) {
                ...
                r.ready().then((function() {
                    return i = r._dbInfo, "[object Blob]" === b.call(n) ? w(i.db).then((function(e) {
                        return e ? n : D(n)
                    })) : n
                })).then((function(n) {
