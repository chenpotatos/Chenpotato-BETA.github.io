...
import {
    P as B
} from "./PictureFilled.875791a4.js";
import {
    ElImage as $
...
import K from "./indexdb.a2b9d265.js";
import {
    gridsumAnalytics as N,
...
import {
    g as W
} from "./globalSearch.6bc5de8d.js";
import {
    c as X
} from "./cloneDeep.3cbd3f2d.js";
import {
    b as H
} from "./_baseFlatten.1b8a9a9c.js";
import {
    b as Q
} from "./_baseOrderBy.365c2f0e.js";
import {
    b as Y
...
import "./_baseIsEqual.cca7ad74.js";
import "./hasIn.0ceeb413.js";
import "./identity.737b3aaf.js";
import "./_baseFor.671df8ff.js";
import "./_overRest.86a13aad.js";
const ea = Y((function(a, e) {
    if (null == a) return [];
    var n = e.length;
    return n > 1 && Z(a, e[0], e[1]) ? e = [] : n > 2 && Z(e[0], e[1], e[2]) && (e = [e[0]]), Q(a, H(e, 1), [])
}));
var na = {
    exports: {}
};
/*! pinyin-engine@1.2.2 | https://github.com/aui/pinyin-engine#readme */
const ia = e(na.exports = function(a) {
        function e(i) {
            ...
            return a[i].call(o.exports, o, o.exports, e), o.l = !0, o.exports
        }
        var n = {};
        return e.m = a, e.c = n, e.d = function(a, n, i) {
        ...
        var i = function() {
            function a(a, e) {
                var n = [],
                    ...
                    t = void 0;
                try {
                    for (var r, l = a[Symbol.iterator](); !(i = (r = l.next()).done) && (n.push(r.value), !e || n.length !== e); i = !0);
                } catch (u) {
                    o = !0, t = u
                } finally {
                    try {
            ...
            return function(e, n) {
                ...
                if (Symbol.iterator in Object(e)) return a(e, n);
        ...
        a.exports = function(a) {
            ...
            for (var t = 0, r = 0, l = e.length; t < l; t++, r++) {
                var u = e[t];
                if (u < 0) r -= u + 1;
                else {
                    var s = String.fromCharCode(r);
                    if ("number" == typeof u) o[s] = [n[u]];
                    else {
                        o[s] = [];
                        for (var p = 0, c = u.length; p < c; p++) o[s].push(n[u[p]])
                    }
                }
            }
            return o
        ...
        var t = function() {
            ...
            r = function() {
                function a(e) {
                    ...
                    o(this, a), this.indexs = [], this.history = {
                        keyword: "",
                        indexs: [],
                        data: []
                    }, this.data = e, this.dict = i, this.prefix = t, n = "string" == typeof n ? [n] : n;
                    var r = !0,
                        l = !1,
                        u = void 0;
                    try {
                        for (var s, p = e[Symbol.iterator](); !(r = (s = p.next()).done); r = !0) {
                            var c = s.value,
                                m = "";
                            if ("string" == typeof c) m = a.participle(c, i, t);
                            else {
                                var d = !0,
                                    h = !1,
                                    f = void 0;
                                try {
                                    for (var g, _ = n[Symbol.iterator](); !(d = (g = _.next()).done); d = !0) {
                                        var v = c[g.value];
                                        v && (m += a.participle(v, i, t))
                                    }
                                } catch (y) {
                                    h = !0, f = y
                                } finally {
                            ...
                            this.indexs.push(m.toLowerCase())
                        }
                    } catch (y) {
                        l = !0, u = y
                    } finally {
                ...
                return t(a, [{
                    key: "query",
                    value: function(a) {
                        if ("" === (a = a.replace(/\s/g, "").toLowerCase())) return [].concat(i(this.data));
                        var e = this.indexs,
                            n = this.data,
                            o = this.history,
                            t = [];
                        o.data.length && 0 === a.indexOf(o.keyword) && (e = o.indexs, n = o.data), o.keyword = a, o.indexs = [];
                        for (var r = 0; r < e.length; r++) - 1 !== e[r].indexOf(this.prefix + a) && (o.indexs.push(e[r]), t.push(n[r]));
                        return t
                    }
                }], [{
                    key: "participle",
                    value: function(a, e) {
                        var n = arguments.length > 2 && void 0 !== arguments[2] ? arguments[2] : "",
                            ...
                            l = void 0;
                        try {
                            for (var u, s = a[Symbol.iterator](); !(t = (u = s.next()).done); t = !0) {
                                var p = e[u.value];
                                p && (o[0].push(p), a.length > 1 && o[1].push(p.map((function(a) {
                                    return a.charAt(0)
                                }))))
                            }
                        } catch (P) {
                        ...
                        var c = !0,
                            ...
                            d = void 0;
                        try {
                            for (var h, f = o[Symbol.iterator](); !(c = (h = f.next()).done); c = !0) {
                                for (var g = h.value, _ = g.shift(); g.length;) {
                                    var v = [],
                                        y = g.shift(),
                                        b = !0,
                                        j = !1,
                                        A = void 0;
                                    try {
                                        for (var E, x = _[Symbol.iterator](); !(b = (E = x.next()).done); b = !0) {
                                            var w = E.value,
                                                D = !0,
                                                k = !1,
                                                O = void 0;
                                            try {
                                                for (var T, I = y[Symbol.iterator](); !(D = (T = I.next()).done); D = !0) {
                                                    var z = T.value;
                                                    v.push(w + z)
                                                }
                                            } catch (P) {
        ...
        var r = function() {
            ...
            c = function(a) {
                function e(a, n, t) {
                    return i(this, e), o(this, (e.__proto__ || Object.getPrototypeOf(e)).call(this, a, n, p, t && "$"))
                }
                return t(e, a), r(e, null, [{
                    key: "participle",
                    value: function(a) {
                        return s.participle(a, p)
                    }
                }]), e
            }(s);
        a.exports = c
    ...
    ta = ["onClick"],
    ra = {
        class: "app-recommend-item-icon"
    },
    la = {
        class: "hfull d-flex-center"
    },
    ua = {
        class: "icon-title f12 d-elip"
    },
    sa = {
        name: "globalSearch-icon"
    },
    pa = n(Object.assign(sa, {
        props: {
            data: {
                type: Array,
                default: []
        ...
        setup(a, {
            ...
            const n = a => {
                let e = a.component.replace("app-", ""),
                    n = a.config && a.config.icon || "";
                return v((() => q(Object.assign({
                    "../DialogApp/app/bookmarks/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.l))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/calendar/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.m))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/clock/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.n))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/countdown/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.p))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/daysMatter/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.q))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/daysMatter/icon/icon2.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.r))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/daysMatter/icon/icon3.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.t))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/eat/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.v))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/habit/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.w))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/ip/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.x))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/jikipedia/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.y))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/laborer11/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.z))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/lusun/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.A))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/movieCalendar/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.B))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/multiavatar/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.E))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/notes/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.F))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/remai/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.G))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/sport/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.H))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/stock/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.I))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/todayEnglish/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.J))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/todayShici/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.K))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/todo/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.M))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/topsearch/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.N))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/uppercase/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.O))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/vgn/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.Q))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/wallpaper/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.R))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/weather/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.T))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/worldClock/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.U))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/xiayigejiaqi/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.V))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/xyzrank/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.W))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url),
                    "../DialogApp/app/yiyan/icon/icon.vue": () => y((() =>
                            import ("./main.354a692e.js").then((a => a.X))), ["./main.354a692e.js", "./el-select.e274bb48.js", "./el-select.e009b2dc.css", "./index.6190cf91.css"],
                        import.meta.url)
                }), `../DialogApp/app/${e}/icon/icon${n}.vue`)))
            };
            return (v, y) => {
                const b = i("d-text-icon"),
                    j = i("el-icon");
                return o(), t("ul", oa, [(o(!0), t(r, null, l(a.data, (i => (o(), t("li", {
                    class: u(["app-recommend-item", {
                        list: a.list
                    }]),
                    onClick: a => function(a, n) {
                        e("urlTo", a, n)
                    }(a, i),
                    key: i.id
                }, [s("div", ra, ["component" == i.type ? (o(), p(c(n(i)), {
                    key: 0,
                    data: i.config,
                    size: "mini"
                }, null, 8, ["data"])) : i && "text" == i.type ? (o(), p(b, {
                    key: 1,
                    bgColor: i.backgroundColor,
                    text: i.iconText
                }, null, 8, ["bgColor", "text"])) : (o(), p(h($), {
                    key: 2,
                    class: "icon-img",
                    style: f(`background-color:${i.backgroundColor}`),
                    src: i.imgSrc || i.src,
                    alt: i.name
                }, {
                    error: m((() => [s("div", la, [d(j, {
                        color: "#fff",
                        size: 16
                    }, {
                        default: m((() => [d(h(B))])),
                    ...
                    _: 2
                }, 1032, ["style", "src", "alt"])), g(' <img class="icon-img" v-else :style="`background-color:${item.backgroundColor}`" :src="item.src"\r\n        :alt="item.name" />')]), s("p", ua, _(i.name), 1), g(' <span class="d-icon f14">\r\n        <TopRight />\r\n      </span>')], 10, ta)))), 128))])
            }
        }
    }), [
        ["__scopeId", "data-v-4fced03e"],
        ["__file", "D:/gitee/new-tab/src/views/globalSearch/icon.vue"]
    ]);
var ca = {};
...
const ma = b,
    ...
    ha = [(0, ma.createElementVNode)("path", {
        d: "M29 27.586l-7.552-7.552a11.018 11.018 0 1 0-1.414 1.414L27.586 29zM4 13a9 9 0 1 1 9 9a9.01 9.01 0 0 1-9-9z",
        fill: "currentColor"
    }, null, -1)];
var fa = ca.default = (0, ma.defineComponent)({
    name: "Search",
    render: function(a, e) {
        return (0, ma.openBlock)(), (0, ma.createElementBlock)("svg", da, ha)
    }
});
const ga = {
    ...
    _a = {
        ...
        class: "d-icon f20 icon-search"
    },
    va = ["onKeydown"],
    ya = {
        class: "global-search-body d-scrollbar-hide"
    },
    ba = {
        class: "mt10"
    },
    ...
    Aa = (a => (R("data-v-5923dc0d"), a = a(), L(), a))((() => s("h2", {
        class: "mt10"
    }, "书签栏", -1))),
    Ea = {
        name: "globalSearch"
    },
    xa = n(Object.assign(Ea, {
        setup(a) {
            const e = X(h(j()));
            A();
            const n = E();
            let i = e.reduce(((a, e) => [...a, ...e.children]), []);
            i = ea(i, (a => -a && a.view));
            const r = x(""),
                l = x([]),
                u = x([]);
            i.forEach((a => {
                a && a.name && "number" == typeof a.name && (a.name = a.name.toString())
            }));
            const c = new ia(i, ["name", "url"]),
                f = w((() => c.query(r.value).slice(0, 8))),
                v = aa(b, 500);

            function y(a, e) {
                a && 229 == a.keyCode || (e || (e = f.value[0]), e && U(a, e, !0))
            }
            async function b() {
                let a = {
                    name: r.value
                ...
                if (!r.value) {
                    ...
                    let e = await K.get("websiteIconTop");
                    if (e) return void(l.value = e)
                }
                F({ ...a,
                    source: "itab",
                    size: 8
                }).then((e => {
                    l.value = e.data || [], a.top && K.set("websiteIconTop", e.data, 432e6)
                })).finally((() => {}))
            }
            return D((() => r.value), (async a => {
                a ? (v(), chrome.bookmarks && chrome.bookmarks.search(a, (a => {
                    let e = (a || []).slice(0, 16);
                    e = e.map((a => ({
                        id: a.id,
                        name: a.title,
                        url: a.url,
                        type: "icon",
                        src: "firefox" == S() ? `https://ico.codelife.cc/faviconV2?client=SOCIAL&type=FAVICON&fallback_opts=TYPE,SIZE,URL&url=${a.url}&size=16` : `chrome://favicon/size/32@2x/${a.url}`
                    }))), u.value = e
                }))) : l.value = await K.get("websiteIconTop", !1)
            })), D((() => W.value), (a => {
                if (a) {
                    r.value = "";
                    let a = {
                ...
                modelValue: h(W),
                "onUpdate:modelValue": e[2] || (e[2] = a => V(W) ? W.value = a : null),
                "append-to-body": "",
                "lock-scroll": !1,
                "modal-class": "global-search-model",
                "show-close": !1,
                width: "700px",
                top: "10vh"
            }, h(n)), {
                header: m((() => [s("div", ga, [s("i", _a, [d(h(fa))]), k(s("input", {
                    autocomplete: "off",
                    id: "keywordInput",
                    "onUpdate:modelValue": e[0] || (e[0] = a => r.value = a),
                    onKeydown: O(T(y, ["prevent"]), ["enter"]),
                    class: "input",
                    type: "text",
                    placeholder: "搜索，支持拼音搜索"
                }, null, 40, va), [
                    [I, r.value, void 0, {
                        trim: !0
                    }]
                ]), k(s("i", {
                    onClick: e[1] || (e[1] = a => r.value = ""),
                    class: "d-icon f16 icon-clear"
                }, [d(h(J))], 512), [
                    [z, r.value]
                ])])])),
                default: m((() => [s("div", ya, [k(d(pa, {
                    Icon: "",
                    onUrlTo: y,
                    data: h(f)
                }, null, 8, ["data"]), [
                    [z, h(f).length]
                ]), s("h2", ba, _(r.value ? "图标库" : "优秀应用"), 1), d(pa, {
                    onUrlTo: y,
                    data: l.value
                }, null, 8, ["data"]), r.value && !h(M)() && "safari" != h(S)() ? (o(), t("span", ja, [Aa, d(pa, {
                    list: !0,
                    onUrlTo: y,
                    data: u.value
                }, null, 8, ["data"])])) : g("v-if", !0)])])),
                _: 1
            }, 16, ["modelValue"]))
        }
    }), [
        ["__scopeId", "data-v-5923dc0d"],
        ["__file", "D:/gitee/new-tab/src/views/globalSearch/index.vue"]
    ]);
export {
    xa as
    default
